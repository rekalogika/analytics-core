...
final class SimpleTimeDimensionHierarchy implements TimeZoneAwareDimensionHierarchy
{
    ...
    public function getHour(): ?Hour
    {
        ...
        return Hour::createFromDatabaseValue($this->hour, $this->timeZone);
    }
    ...
    public function getHourOfDay(): ?HourOfDay
    {
        ...
        return HourOfDay::createFromDatabaseValue($this->hourOfDay, $this->timeZone);
    }
